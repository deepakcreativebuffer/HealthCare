...
const SpecialNotes = ({ onViewAll }) => {
  return (
    <PanelCard
      ...
      headerAction={
        <button 
          onClick={() => onViewAll?.("Special Notes")}
          className="text-[11px] font-bold text-blue-600 hover:text-blue-700 transition-colors active:scale-95"
        >
          View All
        </button>
      }
