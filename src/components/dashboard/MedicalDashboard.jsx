    ...
    <div className="max-w-full mx-auto w-full space-y-2">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 items-start">
          <div className="h-[380px]"><AppointmentsList onViewAll={onViewAll} /></div>
          <div className="h-[380px]"><StaffSchedule onViewAll={onViewAll} /></div>
          <div className="h-[380px]"><StatsList onViewAll={onViewAll} /></div>
          <div className="h-[380px]"><QuickLinks onAdmitClick={() => setIsAdmitModalOpen(true)} /></div>

          <div className="h-[380px]"><ResidentRecords key={`residents-${refreshKey}`} onViewAll={onViewAll} /></div>
          <div className="h-[380px]"><EmployeeRecords onViewAll={onViewAll} /></div>
          <div className="h-[380px]"><SpecialNotes onViewAll={onViewAll} /></div>
          <div className="h-[380px]"><ActivityLog key={`activity-${refreshKey}`} onViewAll={onViewAll} /></div>
        </div>
      </div>
    </div>
  );
