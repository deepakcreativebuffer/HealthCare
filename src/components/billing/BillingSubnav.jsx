    ...
    <div className="bg-slate-50/50 pt-4 px-6 flex flex-col gap-6 shrink-0 border-b border-slate-100">
      ...
      <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
        {secondaryTabs.map((tab) => (
          <button
            key={tab.label}
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-[13px] font-bold transition-all border border-transparent ${
              tab.active 
      ...
      <div className="flex items-center justify-between pb-4">
        ...
        <div className="flex items-center gap-3">
           <div className="flex items-center gap-3 bg-white px-4 py-2.5 rounded-2xl border border-slate-100 shadow-sm">
             ...
             <span className="text-[13px] font-bold text-slate-700">Sep 1, 2025 - Feb 28, 2025</span>
           </div>

           <div className="flex items-center gap-2 bg-white px-4 py-2.5 rounded-2xl border border-slate-100 shadow-sm cursor-pointer hover:bg-slate-50 transition-all">
             <span className="text-[13px] font-bold text-slate-700">Last 6 months</span>
