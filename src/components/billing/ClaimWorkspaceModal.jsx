...
const ClaimWorkspaceModal = ({ isOpen, onClose, claimId }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      {/* Modal Container */}
      <div className="relative bg-white w-full max-w-[1280px] h-[92vh] rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 fade-in duration-300">
        {/* Top Title Bar */}
        ...
        <div className="flex-1 overflow-hidden flex flex-col bg-[#f8fafc]">
          ...
          <div className="px-6 py-2 shrink-0">
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-2.5 flex items-center justify-between">
              <div className="flex items-center gap-6">
                <button
                  onClick={onClose}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 transition-all font-bold group shadow-sm"
                >
                  <ArrowLeft
                    size={14}
                ...
                <div className="flex flex-col">
                  <h2 className="text-[15px] font-extrabold text-slate-800 tracking-tight">
                    Billing — Claim Workspace
                  </h2>
              ...
              <div className="flex items-center gap-2">
                <button className="px-4 py-1.5 rounded-lg border border-slate-200 text-slate-600 font-bold text-[12px] hover:bg-slate-50 transition-all shadow-sm">
                  Save Draft
                </button>
                <button className="px-4 py-1.5 rounded-lg bg-[#009bf2] text-white font-bold text-[12px] shadow-lg shadow-blue-100 hover:bg-[#0089d8] transition-all">
                  Validate & Submit
                </button>
              </div>
            </div>
          ...
          <div className="flex-1 flex overflow-hidden px-6 pb-4 gap-4">
            ...
            <div className="flex-1 flex flex-col gap-4 overflow-hidden">
              ...
              <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`min-w-[100px] px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all border flex flex-col items-start gap-0.5 justify-center leading-tight shadow-sm ${
                      activeTab === tab.id
              ...
              <div className="flex-1 bg-white rounded-xl border border-slate-100 shadow-sm overflow-y-auto no-scrollbar relative min-h-0 p-4">
