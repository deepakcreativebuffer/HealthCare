...
import { Building2, User, MapPin, ChevronDown, FileText, Stethoscope, Activity } from 'lucide-react';
import { billingData } from '../../../data/billingData';

const FieldBox = ({ label, value, isSelect = false }) => (
  <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col gap-1.5 relative overflow-hidden group hover:border-slate-200 transition-all">
  ...
  return (
    <div className="p-8 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-3 text-[#009bf2] mb-2">
        ...
        <h2 className="text-[13px] font-extrabold uppercase tracking-tight">Providers & Service Location</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
           ...
           <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                 <FieldBox label="Provider" value={providers.rendering.name} isSelect={true} />
                 <FieldBox label="NPI" value={providers.rendering.npi} />
                 <FieldBox label="Specialty" value={providers.rendering.specialty} />
              </div>
           </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
           ...
           <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                 <FieldBox label="Facility" value={providers.facility.name} isSelect={true} />
