  ...
  return (
    <div className="p-8 space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center gap-3 text-[#009bf2]">
        ...
        <h2 className="text-[13px] font-extrabold uppercase tracking-tight">Patient Snapshot</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {dataFields.map((field, idx) => (
          ...
          >
             ...
             <span className="text-[14px] font-extrabold text-slate-800">{field.value}</span>
          </div>
        ))}
      </div>
    </div>
