...
const FieldBox = ({ label, value, icon: Icon }) => (
  <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col gap-1.5 relative group hover:border-slate-200 transition-all flex-1">
  ...
  return (
    <div className="p-8 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-3 text-[#009bf2] mb-2">
        ...
        <h2 className="text-[13px] font-extrabold uppercase tracking-tight">Visit / Encounter</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 space-y-1.5 hover:border-slate-200 transition-all group">
           <div className="flex items-center gap-2">
              <span className="text-[14px] font-bold text-slate-400">Linked Visit:</span>
              <span className="text-[14px] font-black text-slate-800 tracking-tight">{visitEncounter.encounterId}</span>
           </div>
        ...
        <div className="flex gap-4">
           <FieldBox label="Date of Service (From)" value={visitEncounter.dosFrom} icon={Calendar} />
           <FieldBox label="Date of Service (To)" value={visitEncounter.dosTo} icon={Calendar} />
