          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/20">
                <th className="px-6 py-4 text-[11px] font-bold text-slate-400 border-b border-slate-100 w-16">
                  #
                </th>
                <th className="px-6 py-4 text-[11px] font-bold text-slate-400 border-b border-slate-100">
                  ICD-10 Code
                </th>
                <th className="px-6 py-4 text-[11px] font-bold text-slate-400 border-b border-slate-100">
                  Description
            ...
            <tbody className="divide-y divide-slate-100">
              {diagnosisSection.map((item, idx) => (
                ...
                >
                  ...
                  <td className="px-6 py-5">
                    <div className="inline-flex px-4 py-2.5 rounded-lg border border-slate-100 bg-white group-hover:border-slate-200 transition-all font-black text-slate-800 text-[14px] min-w-[150px]">
                      {item.code}
                    </div>
                  </td>
                  <td className="px-6 py-5">
