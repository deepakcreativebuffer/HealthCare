export const mockData = {
  residents: [
    ...
    { id: "RES007", name: "Barbara Taylor", age: 70, gender: "Female", roomNumber: "102", admissionDate: "2023-11-25", status: "Active", email: "barbara@care.com", password: "password123" },
    { id: "RES008", name: "William Anderson", age: 88, gender: "Male", roomNumber: "105", admissionDate: "2023-07-14", status: "Active", email: "william@care.com", password: "password123" },
    { id: "RES009", name: "Elizabeth Thomas", age: 74, gender: "Female", roomNumber: "201", admissionDate: "2024-03-05", status: "Under Observation", email: "elizabeth@care.com", password: "password123" },
    { id: "RES010", name: "Richard Moore", age: 81, gender: "Male", roomNumber: "204", admissionDate: "2023-10-18", status: "Active", email: "richard@care.com", password: "password123" },
    { id: "RES011", name: "Dorothy Jackson", age: 77, gender: "Female", roomNumber: "302", admissionDate: "2024-01-22", status: "Active", email: "dorothy@care.com", password: "password123" },
    { id: "RES012", name: "Charles White", age: 84, gender: "Male", roomNumber: "305", admissionDate: "2023-08-30", status: "Active", email: "charles@care.com", password: "password123" },
    { id: "RES013", name: "Patricia Harris", age: 69, gender: "Female", roomNumber: "103", admissionDate: "2023-12-15", status: "Active", email: "patricia@care.com", password: "password123" },
    { id: "RES014", name: "Christopher Martin", age: 73, gender: "Male", roomNumber: "203", admissionDate: "2024-02-28", status: "Active", email: "christopher@care.com", password: "password123" },
    { id: "RES015", name: "Margaret Thompson", age: 90, gender: "Female", roomNumber: "304", admissionDate: "2023-06-10", status: "Active", email: "margaret@care.com", password: "password123" },
    { id: "RES016", name: "Anthony Garcia", age: 71, gender: "Male", roomNumber: "106", admissionDate: "2023-11-02", status: "Discharged", email: "anthony@care.com", password: "password123" },
    { id: "RES017", name: "Susan Martinez", age: 76, gender: "Female", roomNumber: "206", admissionDate: "2024-01-10", status: "Active", email: "susan@care.com", password: "password123" },
    { id: "RES018", name: "Ronald Robinson", age: 83, gender: "Male", roomNumber: "306", admissionDate: "2023-09-05", status: "Active", email: "ronald@care.com", password: "password123" },
    { id: "RES019", name: "Betty Clark", age: 78, gender: "Female", roomNumber: "107", admissionDate: "2023-10-25", status: "Active", email: "betty@care.com", password: "password123" },
    { id: "RES020", name: "Thomas Rodriguez", age: 80, gender: "Male", roomNumber: "207", admissionDate: "2024-02-15", status: "Active", email: "thomas@care.com", password: "password123" }
